...
//  while ((LeftTurnCNT <= LeftUTurn180) || (RightTurnCNT <= LeftUTurn180)) {
...
//  if (AngleM >= StartAngleM) {
//    AngleM = StartAngleM;
//  }
//
//  if (AngleM <= StopAngleM) {
//    AngleM = StopAngleM;
//  }
...
//  Distreading5TurnL  = (BackSensor.distanceInCm() * 10);
...
//  Serial.print(" ");
    ...
    ////***********************************************************************************************************
    //                          FRONT CHECK LEFT / RIGHT 180 TURN
...
ScanForward();
      ...
      if ((Distreading5TurnL <= Distreading5TurnR)){  // && (LeftUTurn180CNT <= 3)) {
//    RightUTurn180On = HIGH;
//             LRcheckForward();
        MoveRightU180AI();
//  ScanForward();
...
//    RightUTurn180On = LOW;
      ...
      if ((Distreading5TurnL >= Distreading5TurnR)){  // && (RightUTurn180CNT <= 3)) {
//    LeftUTurn180On = HIGH;
//              LRcheckForward();
        MoveLeftU180AI();
//  ScanForward();
