...
#define rightPin2A 10
#define rightPin2B 11
...
//    while (Distreading4 >= FarSetPoint4) {
      ...
      if (Distreading4 >= FarSetPoint4)  {
        analogWrite (leftPin1A, speedLeftLeftAI);
        analogWrite (rightPin2A, speedLeftRightAI);
      }
...
//    while (Distreading4L == Distreading4R) {
      ...
      if (Distreading4L == Distreading4R) {
        analogWrite (leftPin1B, speedLeftLeftAI);
        analogWrite (rightPin2B, speedLeftRightAI);
      }
...
//  delay(1000);
    ...
    if (LeftTurnCNT <= RightTurn90) {
      analogWrite (leftPin1A, speedRightLeftAI);
    }
    ...
    if (RightTurnCNT <= RightTurn90) {
      analogWrite (rightPin2B, speedRightRightAI);
    }
...
void loop() {
  ...
  //      MoveForwardRampTestAI();
    ...
    analogWrite (leftPin1A, speedRampForwardAI * 1.155);
    analogWrite (rightPin2A, speedRampForwardAI);
  ...
  //      MoveForwardRampTestAI();
    ...
    analogWrite (leftPin1A, speedRampForwardAI);
    analogWrite (rightPin2A, speedRampForwardAI);
