...
PercentFirstLeftState = FirstLeftState;      //((PercentFirstLeftState <= (FirstLeftState % 10)) && (PercentFirstLeftState >= FirstLeftState % -10)));      
...
PercentSecondLeftState = SecondLeftState;    //((PercentSecondLeftState <= (SecondLeftState % 10)) && (PercentSecondLeftState >= (SecondLeftState % -10)));
      Serial.println("");
      Serial.print("SecondLeftState :");
      Serial.print(SecondLeftState);
      Serial.print(" MM");
...
//PercentFirstRightState = FirstRightState;    //((PercentFirstRightState <= FirstRightState % 10) && (PercentFirstRightState >= FirstRightState % -10));
PercentFirstRightState = constrain (FirstRightState, 100, 200);
...
//PercentSecondRightState = SecondRightState;  //((PercentSecondRightState <= SecondRightState % 10) && (PercentSecondRightState >= SecondRightState % -10));
PercentSecondRightState = constrain (SecondRightState, 100, 200);
  ...
  if ((PercentSecondLeftState >= PercentFirstLeftState) || (PercentFirstLeftState >= PercentSecondLeftState)) {
// MoveStopAI();
// LRcheckForward();
 MoveLeft90AI(); 
}

  if ((PercentSecondRightState >= PercentFirstRightState) || (PercentFirstRightState >= PercentSecondRightState )) {  
// MoveStopAI();
// LRcheckForward();
 MoveLeft90AI(); 
}

  if ((PercentSecondRightState == PercentFirstRightState)){   // && (PercentSecondLeftState == PercentFirstLeftState)){
//MoveStopAI();
 MoveForwardAI();
}
...
//
//  if ((SecondLeftState >= FirstLeftState + 100)) {
// MoveStopAI();
// LRcheckForward();
// MoveLeft90AI(); 
//}
...
////else 
//
////if ((SecondLeftState == FirstLeftState) && (SecondRightState >= FirstRightState + 100)) {
//
//if ((SecondRightState >= FirstRightState + 100)) {  
// MoveStopAI();
// LRcheckForward();
// MoveLeft90AI(); 
//}
