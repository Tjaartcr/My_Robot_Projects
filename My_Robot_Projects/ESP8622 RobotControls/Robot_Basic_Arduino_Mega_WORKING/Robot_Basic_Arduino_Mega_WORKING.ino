...
//**********************************************************
//                  WIFI ANDROID CONTROL DIAGNOSTICS


//  Serial.println("WIFI LEFT SHOULDER:");
//  Serial.println(RemoteXY.left_1_x);
//  Serial.println("");
  
//  Serial.println("WIFI LEFT ELBOW:");
//  Serial.println(RemoteXY.left_1_y);
//  Serial.println("");
//  
//  Serial.println("WIFI RIGHT SHOULDER:");
//  Serial.println(RemoteXY.right_1_x);
//  Serial.println("");
//  
//  Serial.println("WIFI RIGHT ELBOW");
//  Serial.println(RemoteXY.right_1_y);
//  Serial.println("");
  //
  //Serial.println("WIFI FORWARD / REVERSE:");
  //Serial.println(RemoteXY.direction_1_x);
  //Serial.println("");
  //
  //Serial.println("WIFI LEFT / RIGHT");
  //Serial.println(RemoteXY.direction_1_y);
  //Serial.println("");
  //
  //Serial.println("WIFI TORSO:");
  //Serial.println(RemoteXY.torso_1);
  //Serial.println("");
