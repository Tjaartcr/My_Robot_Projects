...
int MoveForwardState = LOW;

#define MoveReverse 37
int MoveReverseState = LOW;

#define MoveLeft 35
int MoveLeftState = LOW;

#define MoveRight 34
int MoveRightState = LOW;

#define MoveRun 38
int MoveRunState = LOW;
 
#define MoveStop 39
int MoveStopState = LOW;

#define Auto_Manual 41
int Auto_ManualState = LOW;

#define Left_Right 40
int Left_RightState = LOW;
...
pinMode(MoveReverse, INPUT_PULLUP);
pinMode(MoveLeft, INPUT_PULLUP);
pinMode(MoveRight, INPUT_PULLUP);

pinMode(MoveRun, INPUT_PULLUP);
...
MoveStopState = digitalRead(MoveStop);

MoveForwardState = digitalRead(MoveForward);
MoveReverseState = digitalRead(MoveReverse);
MoveLeftState = digitalRead(MoveLeft);
MoveRightState = digitalRead(MoveRight);

Auto_ManualState = digitalRead(Auto_Manual);
Left_RightState = digitalRead(Left_Right);
...
Serial.println("");
Serial.print("MoveStopState : ");
Serial.print(MoveStopState);

Serial.println("");
Serial.print("MoveForwardState : ");
Serial.print(MoveForwardState);

Serial.println("");
Serial.print("MoveReverseState : ");
Serial.print(MoveReverseState);

Serial.println("");
Serial.print("MoveLeftState : ");
Serial.print(MoveLeftState);

Serial.println("");
Serial.print("MoveRightState : ");
Serial.print(MoveRightState);

Serial.println("");
Serial.print("Auto_ManualState : ");
Serial.print(Auto_ManualState);

Serial.println("");
Serial.print("Left_RightState : ");
Serial.print(Left_RightState);
